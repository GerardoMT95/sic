 ...
 *
 */
public class InterrogaCapitoloResult 
{
	int annoBilancio;
	...
	String perenti;
	double disponibilitaCompetenza;
	double disponibilitaCassa;
	double cassaBloccata;
	String bloccoLiquidazioni;
	String codiceRisposta;
	 ...
	 * @param upb
	 */
	public InterrogaCapitoloResult() 
	{
		super();
		this.annoBilancio = 0;
		...
		this.perenti = null;
		this.UPB = null;
		this.disponibilitaCompetenza=0;
		this.disponibilitaCassa=0;
	}
	/**
	...
	public double getDisponibilitaCompetenza() {
		return disponibilitaCompetenza;
	}
	public void setDisponibilitaCompetenza(double disponibilitaCompetenza) {
		this.disponibilitaCompetenza = disponibilitaCompetenza;
	}
	public double getDisponibilitaCassa() {
		return disponibilitaCassa;
	}
	public void setDisponibilitaCassa(double disponibilitaCassa) {
	...
	public double getCassaBloccata() {
		return cassaBloccata;
	}
	public void setCassaBloccata(double cassaBloccata) {
		this.cassaBloccata = cassaBloccata;
	}
	public String getBloccoLiquidazioni() {
		return bloccoLiquidazioni;
	}
	public void setBloccoLiquidazioni(String bloccoLiquidazioni) {
		this.bloccoLiquidazioni = bloccoLiquidazioni;
	}
